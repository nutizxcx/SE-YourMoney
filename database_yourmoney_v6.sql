...
--
-- Host: localhost
-- Generation Time: Nov 29, 2019 at 11:19 AM
...
CREATE TABLE `activity_log` (
  ...
  `activity_action` text COLLATE utf8_bin,
...
CREATE TABLE `credit` (
  ...
  `credit_interest` text COLLATE utf8_bin NOT NULL,
  `time_period` text COLLATE utf8_bin NOT NULL,
  `credit_limit` text COLLATE utf8_bin NOT NULL,
  `credit_minimum_income` text COLLATE utf8_bin NOT NULL,
  `credit_type` text COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `monthly_fee` (
  ...
  `fee_type` text COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
ALTER TABLE `monthly_fee`
  MODIFY `fee_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100001;
